...
let zero = document.querySelector(".numZero");
let one = document.querySelector(".numOne");
let two = document.querySelector(".numTwo");
let three = document.querySelector(".numThree");
let four = document.querySelector(".numFour");
let five = document.querySelector(".numFive");
let six = document.querySelector(".numSix");
let seven = document.querySelector(".numSeven");
let eight = document.querySelector(".numEight");
let nine = document.querySelector(".numNine");
...
console.log('hi there yet again')
console.log('hello')